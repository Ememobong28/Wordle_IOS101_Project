  ...
  func set(style: LetterCellStyle) {
    ...
    // ...
      switch style {
          ...
          case .correctLetterOnly:
            let correctLetterOnlyColor = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0)
            contentView.backgroundColor = correctLetterOnlyColor
            layer.borderColor = correctLetterOnlyColor.cgColor

          case .correctLetterAndPosition:
            let correctLetterAndPositionColor = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0)
            contentView.backgroundColor = correctLetterAndPositionColor
            layer.borderColor = correctLetterAndPositionColor.cgColor
        }
    // END YOUR CODE HERE
  }
}
